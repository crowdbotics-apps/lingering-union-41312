"""
Django settings for lingering_union_41312 project.
...
ROOT_URLCONF = 'lingering_union_41312.urls'
...
WSGI_APPLICATION = 'lingering_union_41312.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "lingering_union_41312 API",
    "DESCRIPTION": "API documentation for lingering_union_41312 App",
    "VERSION": "v1",
}
